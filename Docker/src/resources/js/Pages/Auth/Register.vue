        ...
        <div :class="[
            ...
            <form @submit.prevent="submit" class="space-y-5 relative z-10">
                ...
                <div>
                    ...
                    <p v-if="form.errors.password_confirmation" class="mt-1 text-red-400 text-sm">{{ form.errors.password_confirmation }}</p>
                </div>
                ...
                <div class="text-center mt-8">
                    <a href="/login" :class="[
                        ...
                        isDarkMode ? 'text-[#b0b0b0] hover:text-white' : 'text-gray-600 hover:text-gray-900'
                    ]">すでにアカウントをお持ちの方はこちら</a>
                </div>
            </form>
        </div>
    </div>
